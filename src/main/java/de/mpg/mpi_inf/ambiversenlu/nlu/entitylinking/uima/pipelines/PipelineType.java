...
public enum PipelineType {
  ...
  PREPROCESSED_ENTITY_SALIENCE(new EntitySaliencePreprocessed()),
  PREPROCESSED_ENTITY_SALIENCE_STANFORD(new EntitySalienceStanfordPreprocessed()),
  PREPROCESSED_ENTITY_CONCEPT_SALIENCE(new EntityConceptSaliencePreprocessed()),
  PREPROCESSED_ENTITY_CONCEPT_SALIENCE_STANFORD(new EntityConceptSalienceStanfordPreprocessed()),
